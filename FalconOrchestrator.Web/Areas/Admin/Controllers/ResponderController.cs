...
namespace FalconOrchestratorWeb.Areas.Admin.Controllers
{
    ...
    {
        private readonly ResponderRepository repo = new ResponderRepository();
        ...
        {
            return View(new ResponderViewModel());
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(ResponderViewModel model)
        {
