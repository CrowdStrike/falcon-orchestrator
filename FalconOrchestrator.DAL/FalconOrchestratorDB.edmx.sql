...
-- --------------------------------------------------
-- Date Created: 05/12/2016 16:22:32
-- Generated from EDMX file: C:\Users\Falcon\Documents\Visual Studio 2015\Projects\FalconOrchestrator\FalconOrchestrator.DAL\FalconOrchestratorDB.edmx
-- --------------------------------------------------

SET QUOTED_IDENTIFIER OFF;
GO
USE [FalconOrchestrator];
GO
...
IF OBJECT_ID(N'[dbo].[FK_AccountAccountGroups]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[AccountGroups] DROP CONSTRAINT [FK_AccountAccountGroups];
GO
IF OBJECT_ID(N'[dbo].[FK_AccountAccountTicket]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[AccountTickets] DROP CONSTRAINT [FK_AccountAccountTicket];
GO
IF OBJECT_ID(N'[dbo].[FK_AccountEvents]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Detections] DROP CONSTRAINT [FK_AccountEvents];
GO
IF OBJECT_ID(N'[dbo].[FK_CustomerAuthenticationLogs]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[AuthenticationLogs] DROP CONSTRAINT [FK_CustomerAuthenticationLogs];
GO
IF OBJECT_ID(N'[dbo].[FK_CustomerCustomerIOCEvent]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CustomerIOCEvents] DROP CONSTRAINT [FK_CustomerCustomerIOCEvent];
GO
IF OBJECT_ID(N'[dbo].[FK_CustomerDetection]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Detections] DROP CONSTRAINT [FK_CustomerDetection];
GO
IF OBJECT_ID(N'[dbo].[FK_CustomerDetectStatusLogs]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[UserActivityLogs] DROP CONSTRAINT [FK_CustomerDetectStatusLogs];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionDetectionTaxonomies]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DetectionTaxonomies] DROP CONSTRAINT [FK_DetectionDetectionTaxonomies];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionDeviceCustomerIOCEvent]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[CustomerIOCEvents] DROP CONSTRAINT [FK_DetectionDeviceCustomerIOCEvent];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionDeviceDetection]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Detections] DROP CONSTRAINT [FK_DetectionDeviceDetection];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionDnsRequests]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DnsRequests] DROP CONSTRAINT [FK_DetectionDnsRequests];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionDocumentsAccessed]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DocumentsAccesses] DROP CONSTRAINT [FK_DetectionDocumentsAccessed];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionEventTags]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DetectionTags] DROP CONSTRAINT [FK_DetectionEventTags];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionExecutablesWritten]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ExecutablesWrittens] DROP CONSTRAINT [FK_DetectionExecutablesWritten];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionNetworkAccesses]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[NetworkAccesses] DROP CONSTRAINT [FK_DetectionNetworkAccesses];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionScanResults]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ScanResults] DROP CONSTRAINT [FK_DetectionScanResults];
GO
IF OBJECT_ID(N'[dbo].[FK_DetectionTicketEvent]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DetectionTickets] DROP CONSTRAINT [FK_DetectionTicketEvent];
GO
IF OBJECT_ID(N'[dbo].[FK_DeviceDetectionDevice]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DetectionDevices] DROP CONSTRAINT [FK_DeviceDetectionDevice];
GO
IF OBJECT_ID(N'[dbo].[FK_DeviceDeviceTicket]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DeviceTickets] DROP CONSTRAINT [FK_DeviceDeviceTicket];
GO
IF OBJECT_ID(N'[dbo].[FK_GroupsAccountGroups]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[AccountGroups] DROP CONSTRAINT [FK_GroupsAccountGroups];
GO
IF OBJECT_ID(N'[dbo].[FK_ResponderDetection]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Detections] DROP CONSTRAINT [FK_ResponderDetection];
GO
IF OBJECT_ID(N'[dbo].[FK_ResponderResponderSchedule]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ResponderSchedules] DROP CONSTRAINT [FK_ResponderResponderSchedule];
GO
IF OBJECT_ID(N'[dbo].[FK_SeverityDetection]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Detections] DROP CONSTRAINT [FK_SeverityDetection];
GO
IF OBJECT_ID(N'[dbo].[FK_SeverityTicket]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tickets] DROP CONSTRAINT [FK_SeverityTicket];
GO
IF OBJECT_ID(N'[dbo].[FK_StatusDetection]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Detections] DROP CONSTRAINT [FK_StatusDetection];
GO
IF OBJECT_ID(N'[dbo].[FK_TagEventTags]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DetectionTags] DROP CONSTRAINT [FK_TagEventTags];
GO
IF OBJECT_ID(N'[dbo].[FK_TaxonomyDetectionTaxonomies]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DetectionTaxonomies] DROP CONSTRAINT [FK_TaxonomyDetectionTaxonomies];
GO
IF OBJECT_ID(N'[dbo].[FK_TaxonomyTypesTaxonomy]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Taxonomies] DROP CONSTRAINT [FK_TaxonomyTypesTaxonomy];
GO
IF OBJECT_ID(N'[dbo].[FK_TicketAccountTicket]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[AccountTickets] DROP CONSTRAINT [FK_TicketAccountTicket];
GO
IF OBJECT_ID(N'[dbo].[FK_TicketDetectionTicket]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DetectionTickets] DROP CONSTRAINT [FK_TicketDetectionTicket];
GO
IF OBJECT_ID(N'[dbo].[FK_TicketDeviceTicket]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[DeviceTickets] DROP CONSTRAINT [FK_TicketDeviceTicket];
GO
IF OBJECT_ID(N'[dbo].[FK_TicketRecipientTicket]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Tickets] DROP CONSTRAINT [FK_TicketRecipientTicket];
GO
IF OBJECT_ID(N'[dbo].[FK_WhitelistTypeWhitelist]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[Whitelists] DROP CONSTRAINT [FK_WhitelistTypeWhitelist];
GO
...
GO
IF OBJECT_ID(N'[dbo].[AccountTickets]', 'U') IS NOT NULL
    DROP TABLE [dbo].[AccountTickets];
GO
IF OBJECT_ID(N'[dbo].[AuthenticationLogs]', 'U') IS NOT NULL
    DROP TABLE [dbo].[AuthenticationLogs];
GO
IF OBJECT_ID(N'[dbo].[Configurations]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Configurations];
GO
IF OBJECT_ID(N'[dbo].[CustomerIOCEvents]', 'U') IS NOT NULL
    DROP TABLE [dbo].[CustomerIOCEvents];
GO
IF OBJECT_ID(N'[dbo].[Customers]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Customers];
GO
IF OBJECT_ID(N'[dbo].[DetectionDevices]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DetectionDevices];
GO
IF OBJECT_ID(N'[dbo].[Detections]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Detections];
GO
IF OBJECT_ID(N'[dbo].[DetectionTags]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DetectionTags];
GO
IF OBJECT_ID(N'[dbo].[DetectionTaxonomies]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DetectionTaxonomies];
GO
IF OBJECT_ID(N'[dbo].[DetectionTickets]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DetectionTickets];
GO
IF OBJECT_ID(N'[dbo].[Devices]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Devices];
GO
IF OBJECT_ID(N'[dbo].[DeviceTickets]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DeviceTickets];
GO
IF OBJECT_ID(N'[dbo].[DnsRequests]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DnsRequests];
GO
IF OBJECT_ID(N'[dbo].[DocumentsAccesses]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DocumentsAccesses];
GO
IF OBJECT_ID(N'[dbo].[ExecutablesWrittens]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ExecutablesWrittens];
GO
IF OBJECT_ID(N'[dbo].[Groups]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Groups];
GO
IF OBJECT_ID(N'[dbo].[NetworkAccesses]', 'U') IS NOT NULL
    DROP TABLE [dbo].[NetworkAccesses];
GO
IF OBJECT_ID(N'[dbo].[Responders]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Responders];
GO
IF OBJECT_ID(N'[dbo].[ResponderSchedules]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ResponderSchedules];
GO
IF OBJECT_ID(N'[dbo].[ScanResults]', 'U') IS NOT NULL
    DROP TABLE [dbo].[ScanResults];
GO
...
GO
IF OBJECT_ID(N'[dbo].[TaxonomyTypes]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TaxonomyTypes];
GO
IF OBJECT_ID(N'[dbo].[TicketRecipients]', 'U') IS NOT NULL
    DROP TABLE [dbo].[TicketRecipients];
GO
IF OBJECT_ID(N'[dbo].[Tickets]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Tickets];
GO
IF OBJECT_ID(N'[dbo].[UserActivityLogs]', 'U') IS NOT NULL
    DROP TABLE [dbo].[UserActivityLogs];
GO
IF OBJECT_ID(N'[dbo].[Whitelists]', 'U') IS NOT NULL
    DROP TABLE [dbo].[Whitelists];
GO
IF OBJECT_ID(N'[dbo].[WhitelistTypes]', 'U') IS NOT NULL
    DROP TABLE [dbo].[WhitelistTypes];
GO
